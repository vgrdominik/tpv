      ...
      domain: {
        ...
        customer: {
          fields: [
            ...
            {name: "text_tpv", type: 'string'},
            {name: "img", type: 'string'},
            {name: "img_secondary", type: 'string'},
            {name: "reference", type: 'string'},

            {name: "gender", type: 'string'},
            {name: "origin", type: 'string'},
            {name: "social_security_card", type: 'string'},
            {name: "pension_amount", type: 'float'},
            ...
            {name: "notifications_basic_enabled", type: 'int'},
            {name: "notifications_publicity_enabled", type: 'int'},
            {name: "notifications_others_enabled", type: 'int'},

            {name: "taxonomy_sms", type: 'int'},
            {name: "taxonomy_email", type: 'int'},

            {name: "points", type: 'int'},
            {name: "level", type: 'int'},

            {name: "periodicity", type: 'string'},
            {name: "account_charge", type: 'string'},
            {name: "rate", type: 'string'},
            {name: "surcharge", type: 'string'},
            {name: "countable_code", type: 'string'},
            {name: "payment_day", type: 'string'},
            {name: "payment_day2", type: 'string'},
            {name: "payment_bank", type: 'int'},
            {name: "payment_entity", type: 'int'},
            {name: "payment_agency", type: 'int'},
            {name: "payment_control_digit", type: 'int'},
            {name: "payment_account", type: 'int'},
            {name: "payment_method", type: 'string'},
            {name: "discount_document", type: 'float'},
            {name: "discount_product", type: 'float'},
            {name: "discount_prompt_payment", type: 'float'},

            {name: "diners", type: 'int'},
            {name: "table_id", type: 'int'},
            {name: "table_in_use", type: 'boolean'},
            {name: "dinning_room_id", type: 'int'},

            {name: "enabled", type: 'boolean'},

            {name: "creator_user_id", type: 'int'},
            {name: "update_user_id", type: 'int'},
            {name: "seller_user_id", type: 'int'},

            {name: "birthday_date", type: 'Date'},
            {name: "create_date", type: 'Date'},
            {name: "drop_date", type: 'Date'},
            {name: "update_date", type: 'Date'},
          ],
